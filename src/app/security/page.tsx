...
import { Shield, Clock, Globe, Users, AlertTriangle, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Token Expiry</CardTitle>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    Automatic refresh and rotation of access tokens
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                <CheckCircle className="h-4 w-4 text-green-600" />
                <div>
                  <div className="font-medium">Session Blacklisting</div>
                  <div className="text-sm text-muted-foreground">
