												...
												return (
													<Badge
														...
														<div
															...
															className="ml-1 flex items-center justify-center h-4 w-4 cursor-pointer hover:bg-white/20 rounded-sm focus:outline-none focus:ring-1 focus:ring-white/50"
														>
															<XCircle
																className={cn(
																	"h-3 w-3",
